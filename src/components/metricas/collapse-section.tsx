...
export function CollapseSection({ title, description, badge, defaultOpen = false, children }: CollapseSectionProps) {
  ...
  return (
    ...
    >
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-start gap-3 px-4 py-3.5 sm:px-5 text-left transition-colors"
        style={{
